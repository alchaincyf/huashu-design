...
任务开始时可以问多个问题，但必须一次性批量问，按类别组织。问题多不是问题；无依据地替用户做关键设计决策才是问题。

推荐问题类别：

**Goal**
1. 这个视觉产物最终用在哪里？汇报、展示、网站、社媒、答辩，还是内部讨论？
2. 最重要的观众是谁？
3. 观众看完后应该记住什么？
...
4. 必须出现哪些信息？
5. 哪些信息可以弱化或不出现？
6. 有没有真实数据、截图、产品图、logo、文案？

**Brand / Style**
7. 有现成品牌规范、logo、色板、字体、UI 截图吗？
8. 有没有喜欢或讨厌的参考风格？
9. 更偏正式、技术、商业、极简、活泼，还是其他方向？

**Deliverable**
10. 最终要 HTML、PPTX、PDF、PNG/SVG，还是多种格式？
11. 是需要可编辑，还是只需要最终展示图？
12. 尺寸比例有要求吗？16:9、网页 hero、社媒封面，还是自定义？

如果用户已经给了足够上下文，可以不问全套；但不能为了「省事」跳过会影响方向的关键问题。
