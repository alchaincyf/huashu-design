...
const receiptPath = path.join(repoRoot, 'plugins', 'huashu-design', 'release-receipt.json');
...
const versionPaths = [
  ...
  ['plugins/huashu-design/plugin.json', (value) => value.version],
  ['plugins/huashu-design/.claude-plugin/plugin.json', (value) => value.version],
  ['plugins/huashu-design/.codex-plugin/plugin.json', (value) => value.version],
];
...
const manifestPaths = [
  ...
  'plugins/huashu-design/.codex-plugin/openai.yaml',
...
function payloadDigest() {
  const files = [...manifestPaths, ...collectFiles('plugins/huashu-design/skills/huashu-design')].sort();
...
function readReceipt() {
  ...
  return readJson('plugins/huashu-design/release-receipt.json');
}
